function Aboutus(){
    return(
        <>
            <div className='hidden sm:block justify-items-center p-6'>
            ...
            {/* <div className='py-4 px-30'>
                <h1 className='text-3xl sm:text-4xl font-extrabold mb-9 text-center font-family'>Why Choose Us?</h1>
                <div className='flex sm:justify-between'>
                    <div className='sm:block h-66 w-72 border rounded-2xl shadow-lg px-2 py-7 text-center'>
            ...
            <div className='py-4 px-6 sm:px-30'>

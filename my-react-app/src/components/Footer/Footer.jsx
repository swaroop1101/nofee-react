function Footer(){
    return(
        <>
            {/* main <div className='h-110 bg-[#312d2d] border mt-16 text-white'>
                <div className='upper flex px-30 gap-56 py-15'>
                    <div className='logo content-center'>
                        <h1 className='text-4xl font-extrabold'>PrepVio</h1>
                        <p>v 1.0.0</p>
                    </div>
                ...
                <div className='text-white mt-6 text-center'>
                    ...
                    <div className='py-4 flex items-center justify-center gap-11 flex-wrap'>
                    <a href="javascript:;"
                        class="p-2 rounded-full text-white flex items-center border border-gray-300 justify-center transition-all duration-400 hover:border-gray-100 hover:bg-gray-100 hover:text-black">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 71 72"
                        fill="none">
                        <path
            ...
            <div className='w-full bg-[#312d2d] text-white mt-13 sm:mt-16 md:content-center md:h-110 xl:block'>
                ...
                <div className='text-white mt-6 text-center'>
                    <div>
                        <h1 className='text-2xl'>Follow Us</h1>
                        <div className='py-4 flex items-center justify-center flex-wrap gap-5 sm:gap-11'>
                                <a href="javascript:;"
                                class="p-2 rounded-full text-white flex items-center border border-gray-300 justify-center transition-all duration-400 hover:border-gray-100 hover:bg-gray-100 hover:text-black">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 71 72"
                                fill="none">

function JS() {
  ...
  <div className="sm:borderl  w-300  border rounded bg-blue-100 p-4">
    <div className="flex flex-col sm:flex-row sm:items-start sm:gap-4">
      ...
      <img src="/src/components/Courses/Channels/JavaScript/shraddha.jpeg" className='w-full h-full object-cover'></img>
      </div>
  ...
  <div className="sm:borderl  w-300  border rounded bg-blue-100 p-4">
    <div className="flex flex-col sm:flex-row sm:items-start sm:gap-4">
      ...
      <div className="h-[130px] w-[150px] sm:h-40 sm:w-40 border rounded-md mx-auto sm:mx-0 mb-4 sm:mb-0">
      <img src="/src/components/Courses/Channels/JavaScript/hitesh choudhary.jpg" className='w-full h-full object-cover'></img>
      </div>
  ...
  <div className="sm:borderl  w-300  border rounded bg-blue-100 p-4">
    <div className="flex flex-col sm:flex-row sm:items-start sm:gap-4">
      ...
      <div className="h-[130px] w-[150px] sm:h-40 sm:w-40 border rounded-md mx-auto sm:mx-0 mb-4 sm:mb-0">
      <img src="/src/components/Courses/Channels/JavaScript/mosh.jpg" className='w-full h-full object-cover'></img>
      </div>
      ...
      <div className="flex flex-col sm:w-full">
        ...
        <p className="text-lg font-semibold text-center sm:text-left sm:mt-0 mt-2">Programming with Mosh</p>
        
        <h6 className="text-sm text-gray-700 text-center sm:text-left mt-1">description</h6>
  
        <p className="text-sm text-gray-700 text-center sm:text-left mt-1">
        Mosh is a seasoned software engineer sharing practical coding tutorials and real-world projects to help learners build skills and land tech jobs.</p>

...
function Header() {
    return (
      <>
        {/* 1 <div className='h-13 bg-white shadow-md content-center'>
        ...
        {/* no-responsive <div className='h-13 bg-[#e6e6e6] shadow-md content-center sticky top-0 sm:overflow-hidden md:overflow-hidden'>
        ...
        <div className='h-13 bg-[#e6e6e6] shadow-md content-center sticky top-0 sm:overflow-hidden md:overflow-hidden'>
          <div className='justify-between px-4 flex items-center md:px-14  lg:justify-center:p-4 xl:px-21'>
              ...
              <div class='signup-btn hidden xl:block content-center'>
                <button class='border rounded-full text-center px-4 text-lg'>SignUp</button>
              </div>

              <div class='login-btn hidden xl:block content-center px-2'>
                <button class='border rounded-full text-center px-6 text-lg'>Login</button>
              </div> 
